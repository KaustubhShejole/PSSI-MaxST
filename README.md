This work is an example of improved graph-based interactive image segmentation technique using an efficient pixel segment similarity measure for edge-weight assignment that takes both intensity and smoothness features into account. This was done by Mr. Kaustubh S. Shejole\[https://www.cse.iitb.ac.in/~kaustubhshejole/\] under the guidance of Prof. Gaurav Mishra \[https://vnit.ac.in/engineering/cse/dr-gaurav-mishra/\] at VNIT, Nagpur \[https://vnit.ac.in/\].
