...
# scribbles_from = 'our_markers_imagesgrabcut_graphcut'
# scribbles_from = 'our_markers_grabcut_slic_bh'
scribbles_from = 'analyzing_neighborhood_0_5'
# scribbles_from = 'grabcut'
# scribbles_from = 'grabcut_large'
# scribbles_from = 'grabcut_small'
# scribbles_from = 'complete_grabcut'
