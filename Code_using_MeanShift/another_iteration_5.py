...
file_to_show_path = seg_img_path+'_5_1_' + str(iteration_count_1) + '.png'
...
plt.imshow(image)
plt.imsave(scribbled_img_path + '_5_1' +
...
plt.imshow(mask2)
plt.imsave(mask_img_path + '_5_1_'+str(iteration_count_1 + 1)+'.png',
           mask2)
plt.axis('off')
plt.show()
...
plt.imshow(seg_img)
plt.imsave(seg_img_path + '_5_1_'+str(iteration_count_1 + 1)+'.png',
           seg_img)
plt.axis('off')
plt.show()
