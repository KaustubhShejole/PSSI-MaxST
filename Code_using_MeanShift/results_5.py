...
segmented_image = cv2.imread(
    mask_img_path + '_5_1_'+str(iteration_count_1)+'.png', cv2.IMREAD_GRAYSCALE)  # Convert to grayscale
ground_truth = cv2.imread(ground_truth_path,
                          cv2.IMREAD_GRAYSCALE)  # Convert to grayscale
our_mask = cv2.imread(mask_img_path + '_5_1_'+str(iteration_count_1)+'.png')
...
unique_filename = f"{base_name}_{counter}_5.{extension}"
