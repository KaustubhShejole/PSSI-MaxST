...
parser = argparse.ArgumentParser(description="Read an image by filename")
parser.add_argument("image_name", help="Path to the input image")
...
print("Image name only:", image_num)
